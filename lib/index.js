...
console.log(
  ...
  chalk.hex('#89CFF0').italic('     last updated • 23 Februari 2026\n') +
  chalk.hex('#c084fc').italic('     Modification by @HANZXMARKETNOPE2\n') +
  chalk.hex('#a78bfa').italic('           telegram: @HANZXMARKETNOPE2\n\n') +
